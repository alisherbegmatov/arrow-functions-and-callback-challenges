...
console.log(addSpaces('Hello and welcome to functional programming')) // -> Hello and welcome to functional programming
...
console.log(choose(['Apples', 'Bananas', 'Pancakes'])) // -> Apples

const cubeArea = (x, y, z) => x * y * z

console.log(cubeArea(5, 6, 7)) // -> 210

console.log('7 ------------------------------')

const greeting = (prefix, name) => {
  console.log(`Good morning ${prefix}. ${name}!`)
}
greeting("Mr","Mustard")
/* ***********************************************
